...
<head>
    ...
    <style>
        body {
            background: linear-gradient(to bottom, #000000, #1a1a1a); /* De noir à gris très foncé */
            color: #ffffff;
            margin: 0;
            padding: 20px;
        ...
        a {
            color: #60a5fa; /* Bleu clair pour les liens, visible sur fond noir */
        ...
        ul, ol {
            color: #e0e0e0; /* Gris clair pour les listes */
        }
        code {
        ...
        blockquote {
            border-left: 4px solid #9400D3; /* Bordure violette pour les citations */
            padding-left: 10px;
            margin: 10px 0;
            color: #d1d5db;
        }
        /* Améliorations pour Markdown rendu */
        table {
